...
export const checkStoredReferrer = async (WEB_URL: string): Promise<{ hasStoredReferrer: boolean, url?: string }> => {
  try {
...
export const checkInstallReferrer = async (WEB_URL: string, InstallReferrer: any): Promise<{ hasReferrer: boolean, url?: string }> => {
  try {
